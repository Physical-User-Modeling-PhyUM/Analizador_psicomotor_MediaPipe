#include "posevisualizer.h"

PoseVisualizer::PoseVisualizer(QWidget *parent) : QMainWindow(parent) {
...
PoseVisualizer::~PoseVisualizer() {
    munmap(shm_cam1, WIDTH * HEIGHT * 3);
    munmap(shm_cam2, WIDTH * HEIGHT * 3);
    munmap(shm_kp, 2048);
}

void PoseVisualizer::updateImages() {
...
// Incluir moc para evitar errores de compilación
#include "posevisualizer.moc"
